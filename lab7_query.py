...
def display(window):
    ...
    samples_passed = glGetQueryObjectuiv(query_id[0], GL_QUERY_RESULT)
    print(f"Samples passed (pixels written): {samples_passed}")

    # Based on the result, you can decide what to do
    if samples_passed > 0:
        # Object is visible and rendered to the framebuffer
        print("The prism is visible on the screen.")
    else:
        # Object is not visible and can be culled
        print("The prism is not visible and can be culled.")
...
if __name__ == '__main__':
    ...
    main()
    stop = time.monotonic()
    print('time:', stop - start) # time: 0.647000000020489
